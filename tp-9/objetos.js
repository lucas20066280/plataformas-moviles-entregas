...
console.log("resultado nombreCompletoDePersona: ", nombreCompletoDePersona(personaEjemplo1));
...
console.log("resultado felizCumpleaños: ", felizCumpleaños(persona_cumpleaños));
